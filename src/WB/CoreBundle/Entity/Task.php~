...
class Task
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Entry", mappedBy="task")
     */
    protected $Entries;
     ...
     * Add Entries
     *
     * @param WB\CoreBundle\Entity\Entry $entries
     * @return Task
     */
    public function addEntrie(\WB\CoreBundle\Entity\Entry $entries)
    {
     ...
     * @param WB\CoreBundle\Entity\Entry $entries
     */
    public function removeEntrie(\WB\CoreBundle\Entity\Entry $entries)
    {
