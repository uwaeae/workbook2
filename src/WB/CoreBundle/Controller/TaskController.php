...
use WB\CoreBundle\Form\TaskType;
...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WBCoreBundle:Task')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WBCoreBundle:Task')->find($id);
     ...
     * @Method("POST")
     * @Template("WBCoreBundle:Task:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("WBCoreBundle:Task:edit.html.twig")
     */
